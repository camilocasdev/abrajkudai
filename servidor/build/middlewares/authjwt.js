...
var refreshToken = exports.refreshToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var accessCookie, tookieCookie, accessTookieData, token, aToken, _token, tookieCookieData, current, left, _token2, _aToken;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          accessTookieData = _jsonwebtoken["default"].decode(accessCookie, _config["default"].SECRET_KEY);
          if (!tookieCookie) {
            if (accessTookieData.refresh === true) {
              token = _jsonwebtoken["default"].sign({
                id: accessTookieData.id
              }, _config["default"].SECRET_KEY, {
                expiresIn: _config["default"].EXPIRE_TOKEN.Tookie
              });
              res.cookie('Tookie', token, _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), {}, {
                maxAge: _config["default"].EXPIRE_COOKIE.Tookie
              }));
              aToken = _jsonwebtoken["default"].sign({
                id: accessTookieData.id,
                refresh: true
              }, _config["default"].SECRET_KEY, {
                expiresIn: _config["default"].EXPIRE_TOKEN.accessToken
              });
              res.cookie('accessToken', aToken, _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), {}, {
                maxAge: _config["default"].EXPIRE_COOKIE.accessToken
              }));
              ...
              res.cookie('Tookie', _token, _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), {}, {
                maxAge: _config["default"].EXPIRE_COOKIE.Tookie
              }));
            ...
            tookieCookieData = _jsonwebtoken["default"].decode(tookieCookie, _config["default"].SECRET_KEY);
            current = new Date();
            ...
            if (left < 15 || !tookieCookie) {
              ...
              res.cookie('Tookie', _token2, _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), {}, {
                maxAge: _config["default"].EXPIRE_COOKIE.Tookie
              }));
              if (accessTookieData.refresh === true) {
                ...
                res.cookie('accessToken', _aToken, _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), {}, {
                  maxAge: _config["default"].EXPIRE_COOKIE.accessToken
                }));
              }
            }
...
var isUsuario = exports.isUsuario = /*#__PURE__*/function () {
  ...
  return function isUsuario(_x10, _x11, _x12) {
...
var isEmpleado = exports.isEmpleado = /*#__PURE__*/function () {
  ...
  return function isEmpleado(_x13, _x14, _x15) {
...
var isAdminOrEmpleado = exports.isAdminOrEmpleado = /*#__PURE__*/function () {
  ...
  return function isAdminOrEmpleado(_x16, _x17, _x18) {
