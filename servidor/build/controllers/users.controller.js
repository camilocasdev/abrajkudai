...
exports.update_user = exports.get_user_by_id = exports.get_user = exports.del_user = exports.add_user = void 0;
...
var add_user = exports.add_user = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body, nombre, apellido, contrasena, correo, telefono, role, nuevoUsuario, foundRoles, defaultRole, _defaultRole, emailFound, usuarioGuardado;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body = req.body, nombre = _req$body.nombre, apellido = _req$body.apellido, contrasena = _req$body.contrasena, correo = _req$body.correo, telefono = _req$body.telefono, role = _req$body.role;
        ...
        case 6:
          ...
          _context4.t7 = {
            ...
            correo: _context4.t4,
            telefono: _context4.t5,
            role: _context4.t6
          };
          nuevoUsuario = new _context4.t0(_context4.t7);
          if (!role) {
            _context4.next = 24;
            break;
          }
...
var update_user = exports.update_user = /*#__PURE__*/function () {
  ...
  return function update_user(_x9, _x10) {
