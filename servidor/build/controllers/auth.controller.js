  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          _context.next = 11;
          return _user["default"].comparePassword(contrasena, usuarioEncontrado.contrasena);
        case 11:
        ...
        case 14:
          ...
          if (keepSession === false) {
            ['accessToken', 'Tookie'].forEach(function (name, i) {
              var expire;
              if (name === 'Tookie') {
                expire = {
                  maxAge: _config["default"].EXPIRE_COOKIE[name]
                };
              }
              tokens[i] = _jsonwebtoken["default"].sign({
                ...
                expiresIn: _config["default"].EXPIRE_TOKEN[name]
              });
              res.cookie(name, tokens[i], _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), expire));
            });
          } else {
            ['accessToken', 'Tookie'].forEach(function (name, i) {
              tokens[i] = _jsonwebtoken["default"].sign({
              ...
              res.cookie(name, tokens[i], _objectSpread(_objectSpread({}, _config["default"].COOKIE_CFG), {}, {
                maxAge: _config["default"].EXPIRE_COOKIE[name]
              }));
            });
          }
