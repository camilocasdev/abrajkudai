...
function Honeymoonsuite(){
    return(
        <div>
            <div>
                <title>Honeymoon Suite | Abraj Kudai</title>
            </div>
            <body> 
                    ...
                    <section class="habitacion"> 
                        <article class="habimgcontein">
                            ...
                            <div class="habimgwidth">
                                <img src="https://nicodev.s-ul.eu/eVEkueHl" alt="Imagen de la habitación"/>
                            </div>
                        </article>
                        <article class="habdescontein"> 
                            <div>
                                <h2><strong>Honeymoon Suite</strong></h2>
                                <p>
